    ...
    public static void main(String[]args){
        ...
        try {
            ...
            if((numeroMes == 1) || (numeroMes == 3) || (numeroMes == 5) || (numeroMes == 7) || (numeroMes == 8) || (numeroMes == 10) || (numeroMes == 12)) {
                ...
                System.out.println("Ingrese un número de año entre 2000 y 2019 inclusive:");
                anio = Integer.valueOf(entrada.readLine());

                if((anio >= 2000 && anio <= 2019) && (anio % 4 == 0) && ((anio % 100 != 0) || (anio % 400 == 0))) {
                    System.out.println("En el año " + anio  + " su mes Febrero tenía 29 días");
                } else {
                    System.out.println("En el año " + anio  + " su mes Febrero tenía 28 días");
                }
            }
        } catch (Exception e) {
